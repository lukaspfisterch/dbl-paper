...
This paper formalizes the model, states minimal axioms, and proves four claims establishing
...
The axioms are intentionally constructed such that the claims follow by construction. The contribution is the explicit identification and formalization of these architectural constraints, not the derivation of unexpected consequences. This section summarizes the proof ideas under assumptions A1--A5 (and A6 where stated). Full lemma-based proofs are provided in the supplementary proof files.
...
\medskip
Both cases demonstrate the same structural property: governance decisions are deterministic, recorded before execution, and replayable from authoritative inputs alone. The domain-specific details differ; the architectural guarantees do not.
...
This paper formalized DBL through a minimal set of axioms and showed that, under these assumptions, four properties follow: deterministic governance, invariance of G/L separation, replay equivalence of normative state, and observational non-interference. Together, these properties ensure that normative outcomes are independent of non-deterministic execution behavior and can be reconstructed and audited from an append-only event stream.
