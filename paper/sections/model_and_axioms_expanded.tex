...
The index $t(e)$ establishes logical time. Physical timestamps are observational metadata.
...
where $C = (\text{boundary\_version}, \text{boundary\_config\_hash}, L_{\text{rules}})$ is the boundary configuration.
...
\end{itemize}
This separation is invariant: L cannot make normative decisions, G cannot bypass boundaries.
\end{property}
