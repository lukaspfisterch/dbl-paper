...
\textbf{$\\Delta$ (Delta).} $\\Delta$ denotes an atomic event or action. It is the minimal unit of change represented in the model. $\\Delta$ may be normative or observational depending on its event type.  
