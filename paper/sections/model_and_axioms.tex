...
\textbf{t.} t denotes logical order derived from V. It is defined by the sequence of events in V rather than by wall-clock time.  
\textbf{G.} G is the governance function that produces explicit DECISION events. G operates only on authoritative inputs admitted by L.  
