...
This section defines the core elements of the DBL model. All definitions are part of the formal setup for the claims and proofs.
...
The initial state $S_0$ is a normative initial state that is deterministic, versioned, and non-observational.
...
From these definitions, three immediate properties follow:
